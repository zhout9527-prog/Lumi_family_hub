...
当前开发基线：Windows Server `0.3.0`，Windows/Android Client `0.2.2`。源码位于 [`family-platform`](family-platform)，当前实现边界见 [`family-platform/IMPLEMENTATION.md`](family-platform/IMPLEMENTATION.md)。
...
平台只处理家庭有权使用的资源，不绕过付费、DRM、验证码、登录或站点保护。Bilibili 功能仅支持无需 Cookie 的公开单视频，并在入库前执行隔离和人工审核。
